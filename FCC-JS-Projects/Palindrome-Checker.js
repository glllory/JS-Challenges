...
function palindrome(str) {
    // Good luck!
    let palindrome_forward = str.replace(/\W|\_/g, '').toLowerCase();
    let palindrome_backward = [...palindrome_forward].reverse().join('');

    return palindrome_forward === palindrome_backward;
}
